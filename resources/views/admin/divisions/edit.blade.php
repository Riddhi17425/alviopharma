    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Divisions Edit</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('divisions.update', $data->id) }}" data-divisions-form>
            @csrf
            @method('PATCH')
                            ...
                            <div class="row g-3 align-items-start">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                        ...
                                        value="{{ old('name', $data->name) }}" placeholder="Divisions title">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="url" name="url" class="form-control"
                                        data-divisions-url
                                        value="{{ old('url', $data->url) }}" placeholder="divisions-url">
                                    @if ($errors->has('url'))
