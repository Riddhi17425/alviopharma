                ...
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="sub_title" name="sub_title" required class="form-control">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea id="header_description" name="header_description" class="form-control"></textarea>
                        </div>
                        <div class="col-md-12">
