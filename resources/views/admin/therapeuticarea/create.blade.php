...
@section('title', 'Therapeutic Areas Add')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                <h3 class="fw-bold mb-0">Therapeutic Areas Add</h3>
            </div>
        </div>
    </div>

    <div class="card-body">
        <form method="post" action="{{ route('therapeuticarea.store') }}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="card-body">
                            <div class="row g-3 align-items-start">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="sub_title" class="form-control" value="{{ old('sub_title') }}" placeholder="Enter sub title">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="sort_description" class="form-control" rows="4" placeholder="Enter short description">{{ old('sort_description') }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="approach_description" name="approach_description" class="form-control" rows="6" placeholder="Enter approach description">{!! old('approach_description') !!}</textarea>
