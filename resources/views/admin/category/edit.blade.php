...
<div class="container-xxl">
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('category.update', $data->id) }}" data-category-form>
            @csrf
            @method('PATCH')
                            ...
                            <div class="row g-3 align-items-start">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                        data-category-title
                                        value="{{ old('name', $data->name) }}" placeholder="Category title">
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="url" name="url" class="form-control"
                                        data-category-url_edit
                                        value="{{ old('url', $data->url) }}" placeholder="category-url" disabled>
                                    @if ($errors->has('url'))
...
<script src="{{ asset('public/admin_public/js/category.js') }}"></script>
@endpush